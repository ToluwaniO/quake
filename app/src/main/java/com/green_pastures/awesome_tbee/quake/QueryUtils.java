...
*/
    ...
    public static ArrayList<Quakes> extractEarthQuakes(String json){
        ...
        ArrayList<Quakes> quakesArrayList = new ArrayList<>();
        ...
        try{
            ...
            if(json != null) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    quakesArrayList.add(new Quakes(properties.getString("place"), properties.getLong("time"), properties.getDouble("mag"), properties.getString("url")));
                }
            }
        ...
        return quakesArrayList;
    }

    public static URL createUrl(String a){
        URL url = null;
    ...
    public static String makeHttpRequest(URL url) throws IOException {
        ...
        try{
            ...
            if(urlConnection.getResponseCode() == 200){
                ...
                Log.e("URL CONNECTION", "Success: " + urlConnection.getResponseCode() + " " + urlConnection.getResponseMessage());
            }
            else{
                Log.e("URL CONNECTION", "Error: " + urlConnection.getResponseCode() + " " + urlConnection.getResponseMessage());
            }
        }
        catch (IOException e){
            Log.e("IO", "Problem retrieving the earthquake JSON results.", e);
        }
        finally {
    ...
    public static ArrayList<Quakes> getQuakes(String link) {
